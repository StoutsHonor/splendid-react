    ...
    return (
      <div>
        <Panel onClick={this.props.toggleModalDetails} style={{cursor:"pointer"}}>
          ...
          <div className="col-sm-3">
            <i className="fa fa-superpowers fa-2x" style={{color:'gray'}}>0</i>
            <i className="fa fa-superpowers fa-2x" style={{color:'blue'}}>0</i>
            <i className="fa fa-superpowers fa-2x" style={{color:'green'}}>0</i>
            <i className="fa fa-superpowers fa-2x" style={{color:'red'}}>0</i>
            <i className="fa fa-superpowers fa-2x" style={{color:'black'}}>0</i>
          </div>
          <div className="col-sm-3" style={{fontSize: 18}}>
