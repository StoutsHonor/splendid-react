    ...
    return (
      <Panel>
        <div 
          ...
          <div className="row">
            <i className="fa fa-superpowers fa-2x col-sm-2" style={{color:'gray'}}>0</i>
            <i className="fa fa-superpowers fa-2x col-sm-2" style={{color:'blue'}}>0</i>
            <i className="fa fa-superpowers fa-2x col-sm-2" style={{color:'green'}}>0</i>
            <i className="fa fa-superpowers fa-2x col-sm-2" style={{color:'red'}}>0</i>
            <i className="fa fa-superpowers fa-2x col-sm-2" style={{color:'black'}}>0</i>
          </div>
